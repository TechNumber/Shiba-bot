...
class Meal(TimedBaseModel):
    ...
    Columns:
        ...
        max_health_time (float): Время действия эффекта в дуэлях. 0,  если эффект перманентный.
        ...
        health_time (float): Время действия эффекта в дуэлях. 0, если эффект перманентный.
        ...
        strength_time (float): Время действия эффекта в дуэлях. 0, если эффект перманентный.
