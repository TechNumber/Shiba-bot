...
class Meal(TimedBaseModel):
    ...
    Columns:
        ...
        max_health_time (float): Время действия эффекта в дуэлях. -1,  если эффект перманентный.
        ...
        health_time (float): Время действия эффекта в дуэлях. -1, если эффект перманентный.
        ...
        strength_time (float): Время действия эффекта в дуэлях. -1, если эффект перманентный.
    ...
    effects = relationship("Effect", backref=backref("meals", cascade='delete'),
                           passive_deletes=True)
    ...
    max_health_time = Column(Integer)  # Время действия эффекта в дуэлях. -1, если эффект перманентный
    ...
    health_time = Column(Integer)  # Время действия эффекта в дуэлях. -1, если эффект перманентный
    ...
    strength_time = Column(Integer)  # Время действия эффекта в дуэлях. -1, если эффект перманентный
    ...
    agility_time = Column(Integer)  # Время действия эффекта в дуэлях. -1, если эффект перманентный
