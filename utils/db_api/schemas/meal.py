...
class Meal(TimedBaseModel):
    ...
    max_health_time = Column(Float)  # Время действия эффекта в минутах. 0, если эффект перманентный
    ...
    health_time = Column(Float)  # Время действия эффекта в минутах. 0, если эффект перманентный
    ...
    strength_time = Column(Float)  # Время действия эффекта в минутах. 0, если эффект перманентный
