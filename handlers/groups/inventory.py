...
from keyboards.inline.callback_datas import buy_item_callback, discard_item_callback, \
...
@dp.callback_query_handler(IsCalledByOwner(), cancel_callback.filter(cancel_type="equip"), state=GameState.inventory)
